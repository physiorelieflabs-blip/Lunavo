...
import adminAiStoreCreatorRouter from "./admin-ai-store-creator";
...
import publicStoreAuctionsRouter from "./public-store-auctions";
...
router.use(adminAiStoreCreatorRouter);
...
router.use(publicStoreAuctionsRouter);
