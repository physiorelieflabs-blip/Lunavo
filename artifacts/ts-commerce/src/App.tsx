...
function AuthPageFrame({ children, footer }: { children: ReactNode; footer?: ReactNode }) { return <div className="noise flex min-h-[100dvh] flex-col items-center justify-center bg-background px-4 py-8"><div className="mb-7 text-center"><Link href="/" className="inline-flex" data-testid="link-auth-logo"><span className="font-mono text-xs font-medium tracking-[.08em] text-[#1f2b38]">TS COMMERCE PLATTFORM</span></Link><p className="studio-kicker mt-3 text-center">A clearer way to run your commerce</p></div>{children}{footer}</div>; }
