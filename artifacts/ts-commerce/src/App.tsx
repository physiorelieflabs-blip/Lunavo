...
function SubscriptionGate({ children }: { children: ReactNode }) {
  ...
  return <main className="grid min-h-[100dvh] place-items-center bg-[#182333] px-5 py-10 text-[#f8f3e8]"><section className="w-full max-w-2xl rounded-2xl border border-[#516176] bg-[#223247] p-7 shadow-[0_24px_70px_rgba(0,0,0,.25)] md:p-10"><p className="font-mono text-[10px] uppercase tracking-[.18em] text-[#d6aa46]">Workspace paused</p><h1 className="mt-3 text-4xl font-extrabold tracking-[-.07em]">Choose how you want to pay.</h1><p className="mt-4 max-w-xl text-sm leading-6 text-[#c5ced8]">The workspace is locked until a payment method is selected. Dashboard earnings unlocks it for 15 days while you earn enough to settle the fee; bank payment unlocks it after the transfer is verified.</p><div className="mt-7 grid gap-3 sm:grid-cols-3"><div className="rounded-xl border border-[#516176] bg-[#2b3b50] p-4"><p className="font-extrabold">Dashboard</p><p className="mt-1 text-xs leading-5 text-[#b4c0cc]">Unlock for 15 days while you earn.</p></div><div className="rounded-xl border border-[#516176] bg-[#2b3b50] p-4"><p className="font-extrabold">Bank</p><p className="mt-1 text-xs leading-5 text-[#b4c0cc]">Send the exact amount and submit your reference.</p></div><div className="rounded-xl border border-[#516176] bg-[#2b3b50] p-4"><p className="font-extrabold">Retry</p><p className="mt-1 text-xs leading-5 text-[#b4c0cc]">Retry a failed payment or choose another method.</p></div></div><Link href="/billing" className="mt-8 inline-flex rounded-xl bg-[#d6aa46] px-5 py-3 text-sm font-extrabold text-[#182333]">Choose payment method</Link></section></main>;
}
