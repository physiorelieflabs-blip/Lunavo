  ...
  return <main className="min-h-[100dvh] bg-[#f5f1e8] text-[#182333]">
    ...
    <div className="mx-auto max-w-[1240px] px-5 pb-20 pt-8 md:px-10">
      <section className="relative overflow-hidden rounded-[2rem] bg-[#182333] px-6 py-12 text-[#f8f3e8] shadow-[0_20px_60px_rgba(24,35,51,.15)] md:px-12 md:py-16">
        ...
        <p className="font-mono text-[10px] uppercase tracking-[.18em] text-[#d6aa46]">General store · live auctions</p>
        ...
        <p className="mt-5 max-w-2xl text-sm leading-7 text-[#b8c2cc] md:text-base">This is the auction area of the TS Commerce General Store. Every auction has a clear closing time and a visible bid trail.</p>
