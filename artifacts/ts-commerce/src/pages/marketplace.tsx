...
export default function Marketplace() {
  ...
  const load = async () => {
    ...
    try {
      ...
      setError(err instanceof Error ? err.message : 'The shopper marketplace could not be loaded.');
    } finally {
      setLoading(false);
    }
  };
      ...
      <div className="mx-auto max-w-[1280px] px-4 pb-20 pt-6 md:px-8 md:pt-8">
        <section className="relative overflow-hidden rounded-[2rem] bg-[#182333] px-6 py-9 text-[#f8f3e8] shadow-[0_24px_70px_rgba(24,35,51,.16)] md:px-10 md:py-12">
          ...
          <div className="relative z-10 grid gap-8 lg:grid-cols-[1.2fr_.8fr] lg:items-end">
            <div>
              <div className="flex items-center gap-2 font-mono text-[10px] font-bold uppercase tracking-[.2em] text-[#d6aa46]"><ShoppingBag className="h-3.5 w-3.5" /> TS Commerce · shopper marketplace</div>
