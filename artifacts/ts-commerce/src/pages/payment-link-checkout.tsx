...
export default function PaymentLinkCheckout() {
  ...
  const [completed, setCompleted] = useState<{ orderNumber: string; total: number; currency: string; paymentToken: string } | null>(null);
