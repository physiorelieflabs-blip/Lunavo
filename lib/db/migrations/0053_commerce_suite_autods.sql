-- Production commerce suite: opt-in Auto-DS orchestration plus merchant growth features.
...
CREATE INDEX IF NOT EXISTS affiliate_clicks_offer_time_idx ON affiliate_clicks(offer_id, created_at);
...
VALUES ('0053_commerce_suite_autods')
