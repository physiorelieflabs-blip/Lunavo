-- Optional merchant-owned social publishing connections and custom ad media.
...
CREATE TABLE IF NOT EXISTS social_publish_jobs (
  ...
  ad_media_asset_id uuid REFERENCES ad_media_assets(id) ON DELETE SET NULL,
  provider text NOT NULL,
  caption text,
...
VALUES ('0055_social_publishing_and_custom_ad_media')
