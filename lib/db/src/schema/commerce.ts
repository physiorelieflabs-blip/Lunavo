...
export const merchantsTable = pgTable("merchants", {
  ...
  publicStoreKey: text("public_store_key").unique(),
  storefrontTheme: jsonb("storefront_theme").notNull().default({
    accentColor: "#c85d3f",
  ...
  storefrontSections: jsonb("storefront_sections").notNull().default([
...
export const subscriptionsTable = pgTable(
  "subscriptions",
  {
    ...
    dashboardWindowBillingPeriod: text("dashboard_window_billing_period"),
    dashboardAccessStartedAt: timestamp("dashboard_access_started_at", { withTimezone: true }),
    dashboardAccessExpiresAt: timestamp("dashboard_access_expires_at", { withTimezone: true }),
    dashboardWindowUsed: boolean("dashboard_window_used").notNull().default(false),
...
export const paymentsTable = pgTable(
  "payments",
  {
    ...
    tsCommerceFeeMinor: integer("ts_commerce_fee_minor"),
    merchantNetMinor: integer("merchant_net_minor"),
...
export const withdrawalsTable = pgTable(
  "withdrawals",
  {
    ...
    reviewedAt: timestamp("reviewed_at", { withTimezone: true }),
    paidAt: timestamp("paid_at", { withTimezone: true }),
    payoutProvider: text("payout_provider").notNull().default("manual"),
